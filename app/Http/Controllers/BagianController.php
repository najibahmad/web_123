...
class BagianController extends Controller
{
  public function __construct()
  {
     ...
     */
     ...
     {
         //
         $muspida_list = DinasBadanBagian::orderBy('id','desc')->where('jenis','=','bagian')->paginate(10);
         ...
         if ($request->ajax()) {
             ...
             $authors = DinasBadanBagian::select([DB::raw('@rownum  := @rownum  + 1 AS rownum'),'nama', 'pimpinan','jabatan','alamat','telp','website','email','id'])->where('jenis','=','bagian');
         ...
         return view('bagian.index')->with(compact('html','muspida_list','jumlah_muspida'));
     }
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()){
          return redirect('bagian/create')->withInput()->withErrors($validator);
        }
    ...
    public function edit($id)
    {
        ...
        return view('bagian.edit', compact('muspida'));
    }
