...
class DinasController extends Controller
{
  public function __construct()
  {
    ...
    {
        //
        $muspida_list = DinasBadanBagian::orderBy('id','desc')->where('jenis','=','dinas')->paginate(10);
        ...
        if ($request->ajax()) {
            ...
            $authors = DinasBadanBagian::select([DB::raw('@rownum  := @rownum  + 1 AS rownum'),'nama', 'pimpinan','jabatan','alamat','telp','website','email','id'])->where('jenis','=','dinas');
        ...
        return view('dinas.index')->with(compact('html','muspida_list','jumlah_muspida'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($validator->fails()){
          return redirect('dinas/create')->withInput()->withErrors($validator);
        }
    ...
    public function edit($id)
    {
        ...
        return view('dinas.edit', compact('muspida'));
    }
